...
module.exports = function InjectAnnotator(writer) {
    this.annotate = function (data) {
        var dependencies = findDependencies(data);
        if (dependencies.length) {
            // Auto import inject annotator.
            writer.appendToBody("import { inject } from \"@yuzu/yep-app/lib/annotators\";");
            writer.appendToDefaultExport("inject = " + JSON.stringify(dependencies));
            writer.addAnnotation("inject", dependencies);
        }
    };
}
